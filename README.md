...
| ------------------| -------- |
| * Front end account creation form links to API endpoint and creates a user account. * Front end login form can access login end point to retrieve access token and refresh token. * Front end logout button clears stored credentials preventing further usage. | ![sprint1](/Documentation/sprint1.png) |
